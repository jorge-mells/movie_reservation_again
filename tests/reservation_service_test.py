...
def test_get_showtimes_correct(session):
...
def test_get_showtimes_invalid_id(session):
...
def test_get_seats_correct(session):
...
def test_get_seats_invalid_id(session):
    generate_concrete_reservations(session)
    reservation_service = ReservationService(session)
...
def test_get_reservations_correct(session):
...
def test_get_reservations_invalid_id(session):
    generate_concrete_reservations(session)
    reservation_service = ReservationService(session)
...
def test_get_reserved_seats_correct(session):
    possible_seats = generate_concrete_seats(session)
    generate_concrete_reservations(session)
    reservation_service = ReservationService(session)
...
def test_get_reserved_seats_invalid(session):
    generate_concrete_reservations(session)
    reservation_service = ReservationService(session)
...
def test_get_reserved_showtimes_correct(session):
    possible_showtimes = generate_concrete_showtimes(session)
    generate_concrete_reservations(session)
    reservation_service = ReservationService(session)
...
def test_get_reserved_showtimes_invalid(session):
    generate_concrete_reservations(session)
    reservation_service = ReservationService(session)
...
def test_create_reservation_correct(session):
    generate_concrete_reservations(session)
    reservation_service = ReservationService(session)
...
def test_create_reservation_invalid(session):
    generate_concrete_reservations(session)
    reservation_service = ReservationService(session)
